...
PRESETS = {
    "yc05": ["1", "15", "2.8", "2.3", "2.2", "2.05", "500"],
    "yc1": ["1", "14", "2.8", "2.3", "2.2", "2.05", "1000"],
    "yc5": ["1", "12", "2.8", "2.3", "2.2", "2.05", "5000"],
    "yc10": ["1", "11", "2.8", "2.3", "2.2", "2.05", "10000"],
    "yc20": ["1", "10", "2.8", "2.3", "2.2", "2.05", "20000"],
    "yc30": ["1", "10", "2.8", "2.3", "2.2", "2.05", "30000"],
    "yc50": ["1", "9", "2.8", "2.3", "2.2", "2.05", "50000"],
    "yc100": ["1", "8", "2.8", "2.3", "2.2", "2.05", "100000"],
    "yc200": ["1", "7", "2.8", "2.3", "2.2", "2.05", "200000"],
    # 3 档短连投策略（1-3手优先，连输3手止损）
    # 稳健：回撤最小，收益较低
    "yc200s": ["1", "3", "2.75", "2.4", "2.1", "2.01", "100000"],
    # 平衡：推荐默认
    "yc200b": ["1", "3", "2.8", "2.4", "2.1", "2.01", "120000"],
    # 进取：收益高、回撤也更高
    "yc200a": ["1", "3", "3.1", "2.1", "2.1", "2.01", "200000"]
}

# 自动分档虚拟预设：执行 `st yc200x` 启用
AUTO_TIER_PRESET_NAME = "yc200x"
